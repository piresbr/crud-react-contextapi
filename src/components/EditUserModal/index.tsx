            ...
            <div className="flex items-center relative w-full max-w-2xl mx-auto h-full">
                <div className="relative w-full rounded-lg shadow bg-gray-700">
                    ...
                    <form className="w-full p-6 space-y-6">
                        <input type="text" placeholder="Nome: " name="nome" className='w-full py-1 px-3 rounded-md bg-transparent border border-gray-200/50 focus:border-blue-500 focus:outline-none transition-colors' />
                        <input type="text" placeholder="Link do avatar: " name="avatar" className='w-full py-1 px-3 rounded-md bg-transparent border border-gray-200/50 focus:border-blue-500 focus:outline-none transition-colors' />
